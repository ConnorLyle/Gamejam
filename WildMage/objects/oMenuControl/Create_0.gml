...
audio_stop_all();
audio_play_sound(snd_Maintheme, 100, true)
// create the list for the menu
menu = ds_list_create();	// list of menu items
ds_list_add(menu, "Start Game", "Controls", "Spellbook", "Exit Game");	// the menu items, add or remove items to customize
...
// text variables
// title
title_text = "---";	// the title of the menu
title_color = c_aqua;	// the title color
